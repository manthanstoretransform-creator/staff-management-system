...
export const V2Shell: React.FC<{
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-[#F8FAFC] font-sans">
      {/* Sidebar */}
      <aside className="flex w-64 shrink-0 flex-col justify-between border-r border-slate-800 bg-[#0B1220] p-6 text-slate-400">
        <div className="flex min-h-0 flex-grow flex-col">
          ...
          <div className="min-h-0 flex-grow space-y-1 overflow-y-auto">
            ...
            >
              ...
              <span className="flex-1">V2 Dashboard</span>
            </button>
            ...
            <div>
              ...
              >
                ...
                <span className="flex-1">V2 Reports</span>
                <svg
                ...
                <ul className="ml-6 mt-1 space-y-0.5 border-l border-slate-800 pl-2.5">
                  {REPORT_LINKS.map((report) => {
                    ...
                    return (
                      <li key={report.id}>
                        <button
                          onClick={() => navigate(`/dashboard-v2/reports/${report.id}`)}
                          className={
            ...
            >
              ...
              <span className="flex-1">V2 Project management</span>
            </button>

            {/* Task Listing */}
            <button
              onClick={() => navigate("/admin/task-listing")}
              className={
                "flex w-full cursor-pointer items-center gap-3 rounded-lg px-3.5 py-3 text-left text-sm font-medium leading-snug transition duration-150 " +
            ...
            >
              ...
              <span className="flex-1">V2 Task Listing</span>
            </button>
            <button
            ...
            >
              ...
              <span className="flex-1">V2 Teams</span>
            </button>
          </div>
        </div>
      ...
      <div className="flex min-w-0 flex-grow flex-col">
        <header className="flex min-h-16 shrink-0 items-center justify-between gap-4 border-b border-[#E2E8F0] bg-white px-8 py-3">
